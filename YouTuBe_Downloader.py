...
def OK():
    ...
    try:
        ...
        label_result.config(text="Error Type the correct link 🤣 ❤️")

    
Button(root,text='Downlaod',width=10,height=10,font=('arial',30,'bold'),bd=1,fg='#FF0000',bg='#0000FF',command=lambda :OK()).place(x=5,y=180)
